...
DIRETORIO_RAIZ = "C:/Users/Flavio/Desktop/Projeto/desafio-votacao-fullstack/fullstack-back/back"  # Substitua pelo caminho real da sua pasta
ARQUIVO_SAIDA = "todos_os_arquivos.txt"
EXTENSOES_PERMITIDAS = [".java", ".xml", ".yml"]  # Extensões a serem incluídas
